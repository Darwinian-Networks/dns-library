...
\input{section/titlepages}		% INCLUDE: all titlepages
\cleardoublepage

\pagestyle{plain}				% display just page numbers
\input{section/abstract}		% INCLUDE: the abstracts (english and german)
\cleardoublepage
%
...
\input{section/chapter-introduction} % INCLUDE: introduction
\input{section/chapter-background} % INCLUDE: related work
\input{section/chapter-darwin}	% INCLUDE: system
\input{section/chapter-dns} % INCLUDE: concepts
\input{section/chapter-applications} % INCLUDE: concepts
\input{section/chapter-conclusion} % INCLUDE: conclusion
\cleardoublepage
